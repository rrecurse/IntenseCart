...
*/
  ...
  class upload {
	...
	function __construct($file='', $destination='', $permissions='775', $extensions='') {
	...
	function parse() {
		...
		global $messageStack;
//error_log(print_r($_FILES[$this->file],1));
      ...
      if ( tep_not_null($file['tmp_name']) && ($file['tmp_name'] != 'none') && is_uploaded_file($file['tmp_name']) ) {
        if (sizeof($this->extensions) > 0) {
          if (!in_array(strtolower(substr($file['name'], strrpos($file['name'], '.'))), $this->extensions)) {
