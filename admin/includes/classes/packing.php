...
*/
  ...
  class packing {
    ...
    global $shipping_weight, $shipping_num_boxes, $total_weight, $boxcount, $shoppingCart, $order;
        ...
        if (method_exists($shoppingCart, 'get_products_for_packaging') ) {
          $productsArray = $shoppingCart->get_products_for_packaging();
        } else {

          $productsArray = $shoppingCart->get_products();
        }
