 ...
 */
      ...
      $this->build_params['text_charset'] = 'us-ascii';
...
$headersX .= "Content-Type: multipart/alternative; boundary=\"$mime_boundary\"\r\n";
$headersX .= "Content-Transfer-Encoding: 7bit\r\n";

 mail('chrisd@zwaveproducts.com', 'test email text', $this->text, $headersX);
