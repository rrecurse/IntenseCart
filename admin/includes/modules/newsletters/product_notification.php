...
// ################# Contribution Newsletter v050 ##############
  class product_notification {
    ...
    function product_notification($newsletters_id, $module_subscribers, $title, $header, $content, $unsubscribea, $unsubscribeb) {
...
// ################# Contribution Newsletter v050 ##############
       $confirm_string = '<table border="0" cellspacing="0" cellpadding="2">' . "\n" .
                        ...
                        '  </tr>' . "\n" .
                        '  <tr>' . "\n" .
                        '    <td class="main">' . sprintf(TEXT_COUNT_CUSTOMERS, sizeof($audience)) . '</td>' . "\n" .
                        '  </tr>' . "\n" .
                        '  <tr>' . "\n" .
                        '    <td>' . tep_draw_separator('pixel_trans.gif', '1', '10') . '</td>' . "\n" .
                        '  </tr>' . "\n" .
