...
class umTransaction {
	...
	function CheckData()
	{
		...
		if(strtolower($this->command)=="capture" || strtolower($this->command)=="creditvoid")
		{
	...
	function Process()
	{
		...
		$data = "UMkey=" . rawurlencode($this->key) . "&" . 
			...
			"UMcurrency=" . rawurlencode($this->currency) . "&" . 
