...
// class methods
    ...
    function javascript_validation() {
      $js = '  if (payment_value == "' . $this->code . '") {' . "\n" .
            '    var cc_owner = document.checkout.cc_owner.value;' . "\n" .
            '    var cc_number = document.checkout.cc_number.value;' . "\n" .
    ...
    function selection() {
      ...
      $selection = array('id' => $this->code,
					   ...
					   array('title' => MODULE_PAYMENT_CC_TEXT_CREDIT_CARD_CVV2,
                                                 'field' => tep_draw_input_field('cc_cvv2', '', 'style="width:40px" maxlength="4"'))));
    ...
    function before_process() {
      ...
      if ((defined('MODULE_PAYMENT_CC_EMAIL')) && (tep_validate_email(MODULE_PAYMENT_CC_EMAIL)) ) {
        ...
        $this->cc_middle = substr($HTTP_POST_VARS['cc_number'], 0, ($len-4));
        $order->info['cc_number'] = str_repeat('*', (strlen($HTTP_POST_VARS['cc_number']) - 4)) . substr($HTTP_POST_VARS['cc_number'], -4);
      }
