...
<?php
	...
	if(!empty($existing_info)) { 
	   	echo tep_draw_hidden_field('billing_name', $existing_info['billing_name'], '');
		echo tep_draw_hidden_field('billing_company', $existing_info['billing_company'], '');
		echo tep_draw_hidden_field('billing_street_address', $existing_info['billing_street_address'], '');
		echo tep_draw_hidden_field('billing_suburb', $existing_info['billing_suburb'], '');
		echo tep_draw_hidden_field('billing_postcode', $existing_info['billing_postcode'], '');
		echo tep_draw_hidden_field('billing_city', $existing_info['billing_city'], '');
		echo tep_draw_hidden_field('billing_state', $existing_info['billing_state'], '');
		echo tep_draw_hidden_field('billing_country', $existing_info['billing_country'], '');

		echo tep_draw_hidden_field('delivery_name', $existing_info['delivery_name'], '');
		echo tep_draw_hidden_field('delivery_company', $existing_info['delivery_company'], '');
		echo tep_draw_hidden_field('delivery_street_address', $existing_info['delivery_street_address'], '');
		echo tep_draw_hidden_field('delivery_suburb', $existing_info['delivery_suburb'], '');
		echo tep_draw_hidden_field('delivery_postcode', $existing_info['delivery_postcode'], '');
		echo tep_draw_hidden_field('delivery_city', $existing_info['delivery_city'], '');
		echo tep_draw_hidden_field('delivery_state', $existing_info['delivery_state'], '');
		echo tep_draw_hidden_field('delivery_country', $existing_info['delivery_country'], '');
	}
    ...
    <td class="main"><table border="0" width="100%" cellspacing="0" cellpadding="2" class="formArea">
      <tr>
        <td class="main"><table border="0" cellspacing="0" cellpadding="2">
                    <tr>
            <td class="main">&nbsp;Customer <?php echo ENTRY_CUSTOMERS_ID; ?></td>
            <td class="main">&nbsp;
<?php
	if ($is_read_only) {
...
<?php
	...
	echo sbs_get_country_list('country', $address['entry_country_id']);

	//echo tep_draw_input_field('country', tep_get_country_name($address['entry_country_id']?$address['entry_country_id']:223)) . '&nbsp;' . ENTRY_COUNTRY_TEXT;
