...
define('CUSTOMERS_NAME', 'Name:');
define('CUSTOMERS_COMPANY', 'Company:');
define('CUSTOMERS_EMAIL', 'Email:');
define('CUSTOMERS_PHONE', 'Phone:');
define('RESET_CUSTOMER_PASSWORD', 'Reset Customer Password:');
...
define('ENTRY_MEMBER', 'Group Active?');
define('ENTRY_MEMBER_YES', 'Yes');
define('ENTRY_MEMBER_NO', 'Disabled');
// EOF Separate Pricing Per Customer
define('TABLE_HEADING_ACCOUNT_CREATED', 'Date Created');
