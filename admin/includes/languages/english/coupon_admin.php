...
define('COUPON_PRODUCTS', 'Restrict to Products');
define('COUPON_CATEGORIES', 'Restrict to Categories');
define('COUPON_PRICE_GROUPS', 'Restrict to Price Group');
...
define('COUPON_BUTTON_CONFIRM', 'Confirm And Save');
...
define('PRICE_GROUPS_HELP', 'Select which pricing group this coupon is valid for. You can hold down the "Control" key to select multiple groups. If no group selected, coupon will be defaulted to the "Retail" pricing group.');
