...
define('HEADING_TITLE', 'Customers/Vendors Groups');
define('HEADING_TITLE_SEARCH', 'Search:');

define('HEADING_TITLE_AFFILIATE_COMMISSION', 'Affiliate Commissions');
...
define('ENTRY_AFFILIATE_COMMISSION_FIRST', 'Affiliate\'s Commission Rate on the First Sale');
define('ENTRY_AFFILIATE_COMMISSION_NEXT', 'Affiliate\'s Commission Rate on the Subsequent Sales');
