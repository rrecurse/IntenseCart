...
define('HEADING_TITLE_SEARCH', 'RMA #');
define('HEADING_TITLE_STATUS', 'Status:');

define('TABLE_HEADING_COMMENTS', 'Comments');
define('TABLE_HEADING_CUSTOMERS', 'Customers');
define('TABLE_HEADING_ORDER_TOTAL', 'Amount');
define('TABLE_HEADING_DATE_PURCHASED', 'Requested');
...
define('TEXT_ALL_ORDERS', 'All RMA\'s');
define('TEXT_NO_ORDER_HISTORY', 'No RMA History Available');
define('ENTRY_PAYMENT_REFERENCE', 'Refund Ref #:');
define('ENTRY_PAYMENT_AMOUNT', 'Refund Amount:');
define('ENTRY_RESTOCK_CHARGE', 'Restock Charge?');

define('ERROR_ORDER_DOES_NOT_EXIST', 'Error: RMA does not exist.');
define('SUCCESS_ORDER_UPDATED', 'Success: RMA %s for order %s has been successfully updated.');
define('WARNING_ORDER_NOT_UPDATED', 'Warning: Nothing to change. The RMA was not updated.');
define('WARNING_ORDER_UPDATED_NOT_COMPLETE', 'Notice: RMA %s for order %s updated, but not yet complete. Status: %s');
define('SUCCESS_CUSTOMER_NOTIFIED', 'Customer %s Notified');
define('SUCCESS_RETURNED_GIFT', 'Refund by Store Credit');
define('SUCCESS_RETURN_CLOSED', 'Return %s now complete!');
...
define('EMAIL_TEXT_COMMENTS_UPDATE', '<b>Comments & Directions to Complete Your Return:</b><br> %s');
?>
