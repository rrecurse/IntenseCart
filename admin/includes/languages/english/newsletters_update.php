...
define('HEADING_TITLE', 'Newsletter Update Manager');

define('TABLE_HEADING_NEWSLETTERS', 'Updates to run');
define('TABLE_HEADING_SIZE', 'Size');
define('TABLE_HEADING_MODULE', 'Module');
define('TABLE_HEADING_SENT', 'Updated');
...
define('TEXT_NEWSLETTER_READ_PROCESS', 'Read HELP before running updates:');
define('TABLE_NEWSLETTER_UPDATE_INFO', 'Click here to see Help');
