<?php
/*  Copyright (c) 2002 - 2014 IntenseCart eCommerce */
  ...
  $payments_query = tep_db_query("SELECT * FROM " . TABLE_AFFILIATE_PAYMENT . " WHERE affiliate_payment_id = '" . tep_db_prepare_input($_GET['pID']) . "'");
      ...
      <tr>
        <td valign="top"><table border="0" cellspacing="0" cellpadding="2">
          <tr>
            ...
            <td class="main"><?php echo (!empty($payments['affiliate_address_format_id'])) ? tep_address_format($payments['affiliate_address_format_id'], $affiliate_address, 1, '&nbsp;', '<br>') : ''; ?></td>
          </tr>
          <tr>
