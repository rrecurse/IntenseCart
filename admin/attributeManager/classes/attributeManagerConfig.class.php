<?php
/*
  $Id: attributeManagerConfig.class.php,v 1.0 01/02/07 $

 IntenseCart, E-Commerce and Internet Marketing Solutions
  http://www.intensecart.com

  Copyrights (c) 2006 IntenseGroup Inc.
...
class attributeManagerConfig {
	...
	function attributeManagerConfig() {
		...
		/**
		 * Use sort order? NOT IMPLEMENTED YET --- DO NOT CHANGE ---
		 */
		 ...
		 * Sort order tables
		 */
		$this->add('AM_FIELD_OPTION_SORT_ORDER','am_option_sort_order');
		$this->add('AM_FIELD_OPTION_VALUE_SORT_ORDER','am_option_value_sort_order');
