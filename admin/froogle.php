...
$OutFile = "../feeds/bodyinacinch.txt"; //"CHANGEME-full-path-to-file-with-777-dir-and-file-permissions.fr-outfile.txt";
$destination_file = "bodyinacinch.txt";  //"CHANGEME-filename-to-upload-to-froogle.txt" ;
$source_file = $OutFile;
$imageURL = 'http://www.bodyinacinch.com/images/';
$productURL = 'http://www.bodyinacinch.com/product_info.php?products_id=';
$already_sent = array();
...
$ftp_user_name = "bodyin_admin";
$ftp_user_pass = "sashaurq1";
...
if($convertCur)
{
$productURL = "http://www.bodyinacinch.com/product_info.php?currency=" . $curType . "&products_id=";  //where CURTYPE is your currency type (eg. USD, EUR, GBP)
}
...
$brand = 0;
$upc = 0;   //Not supported by default IX
$manufacturer_id = 0;  //Not supported by default IX
$product_type = 0;
$currency = 0;
...
$ship_to = 0;
	$default_ship_to = "ALL"; //this is not binary, not supported by default IX for individual products.
$ship_from = 0;
	$default_ship_from = "USD"; //this is not binary, not supported by default IX for individual products.
