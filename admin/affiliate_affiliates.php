...
?>
      ...
      <tr>
        <td><table border="0" width="100%" cellspacing="5" cellpadding="3">
          <tr>			
			   <?php
          switch ($listing) {
              case "id-asc":
          ...
          ?>			
			<td valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr class="dataTableHeadingRow">			  
                <td class="dataTableHeadingContent" align="left" nowrap>&nbsp; <a href="<?php echo "$PHP_SELF?listing=id-asc"; ?>"><?php echo tep_image(DIR_WS_IMAGES . 'arrow_up.png', 'Ascending'); ?></a> ID <a href="<?php echo "$PHP_SELF?listing=id-desc"; ?>"><?php echo tep_image(DIR_WS_IMAGES . 'arrow_down.png', 'Descending'); ?> &nbsp;</a>			
				<td class="dataTableHeadingContent" nowrap>&nbsp; <a href="<?php echo "$PHP_SELF?listing=firstname"; ?>"><?php echo tep_image(DIR_WS_IMAGES . 'arrow_up.png', 'Ascending'); ?></a>&nbsp; First &nbsp;<a href="<?php echo "$PHP_SELF?listing=firstname-desc"; ?>"><?php echo tep_image(DIR_WS_IMAGES . 'arrow_down.png', 'Descending'); ?></a> &nbsp;</td>	
				<td class="dataTableHeadingContent" nowrap>&nbsp; <a href="<?php echo "$PHP_SELF?listing=lastname"; ?>"><?php echo tep_image(DIR_WS_IMAGES . 'arrow_up.png', 'Ascending'); ?></a>&nbsp; Last &nbsp;<a href="<?php echo "$PHP_SELF?listing=lastname-desc"; ?>"><?php echo tep_image(DIR_WS_IMAGES . 'arrow_down.png', 'Descending'); ?></a> &nbsp;</td>			
				<td class="dataTableHeadingContent" align="left" nowrap>&nbsp; Comm. % &nbsp;</td>
                <td class="dataTableHeadingContent" align="center"> <?php echo TABLE_HEADING_USERHOMEPAGE; ?> </td>
                <td class="dataTableHeadingContent" align="right"> Stats </td>			  
			  </tr>
<?php
    $search = '';
    ...
    while ($affiliate = tep_db_fetch_array($affiliate_query)) {
      ...
      if ( (is_object($aInfo)) && ($affiliate['affiliate_id'] == $aInfo->affiliate_id) ) {
        echo '          <tr class="dataTableRowSelected" onmouseover="this.style.cursor=\'pointer\'" onclick="document.location.href=\'' . tep_href_link(FILENAME_AFFILIATE, tep_get_all_get_params(array('acID', 'action')) . 'acID=' . $aInfo->affiliate_id . '&action=edit') . '\'">' . "\n";
      } else {
        echo '          <tr class="dataTableRow" onmouseover="this.className=\'dataTableRowOver\';this.style.cursor=\'pointer\'" onmouseout="this.className=\'dataTableRow\'" onclick="document.location.href=\'' . tep_href_link(FILENAME_AFFILIATE, tep_get_all_get_params(array('acID')) . 'acID=' . $affiliate['affiliate_id']) . '\'">' . "\n";
      }
...
?>
                ...
                <td class="dataTableContent"><div style="width:125px; overflow:hidden;"><?php echo '<a href="' . $affiliate['affiliate_homepage'] . '" target="_blank">' . $affiliate['affiliate_homepage'] . '</a>'; ?></div></td>
                <td class="dataTableContent" align="right"><?php echo '<a href="' . tep_href_link(FILENAME_AFFILIATE_STATISTICS, tep_get_all_get_params(array('acID')) . 'acID=' . $affiliate['affiliate_id']) . '">' . tep_image(DIR_WS_ICONS . 'statistics.gif', ICON_STATISTICS) . '</a>'; ?>&nbsp;</td>
              </tr>
<?php
    }
?>
