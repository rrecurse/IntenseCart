...
<body style="background:transparent; margin:0;" onload="SetFocus();">
    ...
    <td width="100%" valign="top" colspan="2"><table border="0" width="100%" cellspacing="0" cellpadding="2">
      <tr>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="0">
          <tr>
            <td width="50" style="padding-bottom:5px;"><img src="images/currency-icon.gif" width="40" height="40" alt="" border="0"></td>
...
?>
                ...
                <td class="dataTableContent" align="right"><?=$currency['value']>0?number_format(1/$currency['value'], 8):'n/a'?></td>
...
<?php
  ...
  switch ($action) {
    ...
    case 'edit':
      ...
      $contents[] = array('text' => '<br>' . TEXT_INFO_CURRENCY_VALUE . '<br>' . tep_draw_input_field('value', ($cInfo->value>0?sprintf('%.6f',1/$cInfo->value):'')));
    ...
    default:
      if (is_object($cInfo)) {
        ...
        $contents[] = array('text' => TEXT_INFO_CURRENCY_VALUE . ' ' . ($cInfo->value>0?number_format(1/$cInfo->value, 8):'n/a'));
