...
//  if (!is_writable($filenameInc)) $filenameInc = DIR_FS_CATALOG_LOCAL . 'header_tags.php';
  $filenameEng = DIR_FS_CATALOG_LANGUAGES . $language . '/header_tags.php';
  if (!is_writable($filenameEng)) $filenameEng = DIR_FS_CATALOG_LOCAL . "header_tags_$language.php";
