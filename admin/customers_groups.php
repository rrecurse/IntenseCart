...
*/
  ...
  if (tep_not_null($action)) {
    ...
    // By MegaJim
		$group_affiliate_com_first=$HTTP_POST_VARS['group_affiliate_com_first']+0;
		$group_affiliate_com_next=$HTTP_POST_VARS['group_affiliate_com_next']+0;

        tep_db_query("update " . TABLE_CUSTOMERS_GROUPS . " set customers_group_name='" . $customers_group_name . "', customers_group_show_tax = '" . $customers_group_show_tax . "', customers_group_tax_exempt = '" . $customers_group_tax_exempt . "', group_payment_allowed = '". $group_payment_allowed ."', group_shipment_allowed = '". $group_shipment_allowed ."', group_affiliate_com_first='$group_affiliate_com_first', group_affiliate_com_next='$group_affiliate_com_next'  where customers_group_id = " . tep_db_input($customers_group_id) );
...
//--></script>
	...
	echo HEADING_TITLE_AFFILIATE_COMMISSION; ?></td>
      </tr>
      <tr>
        <td class="formArea"><table border="0" cellspacing="2" cellpadding="2">
          <tr>
            <td class="main"><?php echo ENTRY_AFFILIATE_COMMISSION_FIRST; ?></td>
            <td class="main"><?php echo tep_draw_input_field('group_affiliate_com_first', $cInfo->group_affiliate_com_first, 'size="7"'); ?>%</td>
          </tr>
          <tr>
            <td class="main"><?php echo ENTRY_AFFILIATE_COMMISSION_NEXT; ?></td>
            <td class="main"><?php echo tep_draw_input_field('group_affiliate_com_next', $cInfo->group_affiliate_com_next, 'size="7"'); ?>%</td>
          </tr>
	</table>
	</td>
      </tr>
...
<?php
    foreach ($paymods AS $mod=>$m) {
?>
	   <tr>
            <td class="main"><?php echo tep_draw_checkbox_field('payment_allowed[]', $mod , (in_array($mod,$payments_allowed)) ?  1 : 0); ?>&#160;&#160;<?=$m->getName()?></td>
           </tr>
<?php
 } // end foreach
?>
	...
	echo HEADING_TITLE_AFFILIATE_COMMISSION; ?></td>
      ...
      <tr>
        <td class="formArea"><table border="0" cellspacing="2" cellpadding="2">
          <tr>
            <td class="main"><?php echo ENTRY_AFFILIATE_COMMISSION_FIRST; ?></td>
            <td class="main"><?php echo tep_draw_input_field('group_affiliate_com_first', 0, 'size="7"'); ?>%</td>
          </tr>
          <tr>
            <td class="main"><?php echo ENTRY_AFFILIATE_COMMISSION_NEXT; ?></td>
            <td class="main"><?php echo tep_draw_input_field('group_affiliate_com_next', 0, 'size="7"'); ?>%</td>
          </tr>
	</table>
	</td>
      </tr>
