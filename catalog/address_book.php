      ...
      <tr>
        <td>
			<table border="0" width="100%" cellspacing="1" cellpadding="2" class="infoBox">
				<tr>
					<td valign="top" width="50%"><b>Address Use:</b></td>
            	    <td align="center" valign="top"> <b><?php echo PRIMARY_ADDRESS_TITLE; ?></b></td>
					<td style="padding-left: 25px"><b>Address:</b></td>
				</tr>
				<tr>
					<td><?php echo PRIMARY_ADDRESS_DESCRIPTION; ?></td>
					<td align="center" valign="top"><br><?php echo tep_image(DIR_WS_IMAGES . 'checkmark-icon-green.png'); ?></td>
					<td style="padding-left: 25px" valign="top"><?php echo tep_address_label($customer_id, $customer_default_address_id, true, ' ', '<br>'); ?></td>
				</tr>
			</table>
		</td>
	</tr>
              ...
              <tr>
                ...
                <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
                  <tr class="moduleRow" onmouseover="rowOverEffect(this)" onmouseout="rowOutEffect(this)" onClick="document.location.href='<?php echo tep_href_link(FILENAME_ADDRESS_BOOK_PROCESS, 'edit=' . $addresses['address_book_id'], 'SSL'); ?>'">
                    <td class="main"><b><?php echo tep_output_string_protected($addresses['firstname'] . ' ' . $addresses['lastname']); ?></b><?php if ($addresses['address_book_id'] == $customer_default_address_id) echo '&nbsp;<small><i>' . PRIMARY_ADDRESS . '</i></small>'; ?></td> <td class="main" align="right" style="padding-right:20px;"><?php echo '<a href="' . tep_href_link(FILENAME_ADDRESS_BOOK_PROCESS, 'edit=' . $addresses['address_book_id'], 'SSL') . '" style="text-decoration:underline;">edit</a> &nbsp; | &nbsp; <a href="' . tep_href_link(FILENAME_ADDRESS_BOOK_PROCESS, 'delete=' . $addresses['address_book_id'], 'SSL') . '" style="text-decoration:underline;">delete</a>'; ?></td>
                  </tr>
                  <tr>
