...
?>
Not logged in as Affiliate<br>
<a href="<?=tep_href_link(FILENAME_AFFILIATE_SUMMARY)?>">Please log in first</a>
<?
    exit();
  }
...
<table>
<?
    $find_query=tep_db_query("SELECT * FROM ".TABLE_CUSTOMERS." WHERE customers_referred_by='$affiliate_id' AND ".join(' AND ',$find_cond)." LIMIT $find_max");
