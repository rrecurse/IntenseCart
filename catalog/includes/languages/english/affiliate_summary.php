...
define('HEADING_TITLE', STORE_NAME . ' Affiliate Program');
...
define('TEXT_AFFILIATE_BANNERS', 'Affiliate Embed Code');
...
define('TEXT_AFFILIATE_BANNERS_CART', 'Embed Affiliate Cart');
...
define('TEXT_SUMMARY', 'Mouse over [?] to see a description of each category.');
