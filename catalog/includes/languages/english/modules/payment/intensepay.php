<?php
  ...
  define('MODULE_PAYMENT_INTENSEPAY_TEXT_TITLE', 'IntensePay');
  define('MODULE_PAYMENT_INTENSEPAY_TEXT_DESCRIPTION', 'Credit Card Test Info:<br><br>CC#: 4111111111111111<br>Expiry: Any');
  define('MODULE_PAYMENT_INTENSEPAY_TEXT_CREDIT_CARD_TYPE', 'Credit Card Type:');
