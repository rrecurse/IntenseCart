...
define('TEXT_CHOOSE_SHIPPING_METHOD', 'Please select the preferred shipping method to use for this order.');
...
define('FREE_SHIPPING_DESCRIPTION', 'This product will be shipped for free');
