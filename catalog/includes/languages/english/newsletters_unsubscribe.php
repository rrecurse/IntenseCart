...
define('UNSUBSCRIBE_TEXT_INFORMATION', '<br>We\'re sorry to hear that you wish to unsubscribe from our newsletter. If you have concerns about your privacy, please see our <a href="' .FILENAME_PRIVACY . '"><u>privacy notice</u></a>.<br><br>Subscribers to our newsletter are kept notified of new products, and price reductions, and site news.<br><br>If you still do not wish to receive your newsletter, please click the button below.');
define('UNSUBSCRIBE_DONE_TEXT_INFORMATION', '<br>You\'re email address, listed below, has been removed from our Newsletter Subscription list, as per your request.<br><br>');
