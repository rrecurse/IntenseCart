...
*/
  define('TITLE', 'intenseCart eCommerce');
//}
...
define('BOX_HEADING_SEARCH', 'Product Search:');
...
define('BOX_HEADING_CURRENCIES', '<div style="font-size:13px; padding-bottom:2px;">Currencies</div>');
...
define('ENTRY_COMPANY_ERROR', 'Your Company name must contain a minimum of 2 characters.');
define('ENTRY_COMPANY_TEXT', '');

define('ENTRY_COMPANY_TAX_ID', 'Company\'s tax id number:');
define('ENTRY_COMPANY_TAX_ID_ERROR', 'Your Tax ID must contain a minimum of 9 characters.');
...
define('ENTRY_STATE_ERROR_SELECT', 'The state or province you entered appears to be invalid. Please check the spelling or spacing.');
...
define('ENTRY_NEWSLETTER', 'Opt-in for our Newsletter:');
...
define('TEXT_RESULT_PAGE', 'View Page:');
...
define('FOOTER_TEXT_BODY', 'Copyright &copy; 2007 <a href="http://www.intensecart.com" target="_blank">intenseCart</a><br>Powered by <a href="http://www.intensecart.com" target="_blank">intenseCart</a>');
...
define ('IMAGE_REDEEM_VOUCHER', 'Redeem Coupon');

if(!defined('STORE_COUNTRY')) define ('STORE_COUNTRY', '223');
