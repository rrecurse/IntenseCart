 ...
 *
 * Ultimate SEO URLs offers search engine optimized URLS. 
...
/**
 * Function to perform DB inserts and updates
 * @version 1.0
 ...
 *
 * Ultimate SEO URLs offers search engine optimized URLS
 * Other features include optimized performance and 
...
class SEO_URL{
	...
	* @var object
	...
	var $installer;
        ...
        /**
         * FagSoft: Added to prevent notice about undefined property.
         * @var bool
         */
        var $keep_in_memory;
 ...
 * @param boolean $add_session_id Switch to add IXsid
 ...
 */	
	function short_name($str, $limit=3){
		...
		$container = (isset($container) && sizeof($container) > 1) ? implode('-', $container) : $str;
		return $container;
	}
