...
// class methods
    function add($class, $message, $type = 'error') {
      if ($type == 'error') {
        $this->messages[] = array('params' => 'class="messageStackError" style="line-height:35px; height:100%;"', 'class' => $class, 'text' => tep_image(DIR_WS_ICONS . 'error.gif', ICON_ERROR, '', '', 'align="left" vspace="2"') . ' &nbsp; ' . $message);
      } elseif ($type == 'warning') {
