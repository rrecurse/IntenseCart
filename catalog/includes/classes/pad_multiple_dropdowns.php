...
*/
    function _draw_stocked_attributes() {
	  ...
	  if (STOCK_CHECK_ATTRIBUTES!='false') {
          ...
          $out.='<tr><td align="right" class=main><b>'.$attributes[$o]['oname'].":</b></td><td class=main>".tep_draw_pull_down_menu('id['.$attributes[$o]['oid'].']',array_values($attributes[$o]['ovals']),$attributes[$o]['default'], (STOCK_CHECK=='true'?"onchange=\"stkmsg(this.form);\"":""))."</td></tr>\n";
        }        
