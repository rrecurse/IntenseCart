...
webfxLayout = {
	...
	writeMenu			:	function () {
		...
		document.write("<div class='webfx-menu-bar'><a href='http://www.intensivex.com'>Intensivex</a></div>");
	...
	writeDesignedByEdger	:	function () {
		if (ie && document.body.currentStyle.writingMode != null)
			document.write("<div id='webfx-about'>Page designed and maintained by " +
					"<a href='mailto:chris@intensivex.com'>Intensivex Web Development</a> &amp; " +
					"</div>");
	}
};

if (0 && ie && window.attachEvent) {
