...
class usps {
	...
	function __construct() {
		...
		// # display rates only if customer is international?
		$this->intl_only_enabled = (MODULE_SHIPPING_USPS_INTERNATIONAL_ONLY == 'True' ? true : false);

		if($this->intl_only_enabled == true && $order->delivery['country']['iso_code_2'] == 'US') { 
			$this->enabled = false;
		}

		// # enable Stamps.com API?
		$this->Stamps_enabled = (MODULE_SHIPPING_USPS_STAMPS_STATUS == 'True' ? true : false);

		if ( ($this->enabled == true) && ((int)MODULE_SHIPPING_USPS_ZONE > 0) ) {
			$check_flag = false;
			$check_query = tep_db_query("SELECT zone_id 
									 	 FROM " . TABLE_ZONES_TO_GEO_ZONES . " 
										 WHERE geo_zone_id = '" . MODULE_SHIPPING_USPS_ZONE . "' 
...
// 		print_r( $this->quotes );
	...
	function check() {
		if (!isset($this->_check)) {
			$check_query = tep_db_query("select configuration_value from IXcore." . TABLE_CONFIGURATION . " where configuration_key = 'MODULE_SHIPPING_USPS_STATUS'");
	...
	// Install Module
	function install() {
		tep_db_query("ALTER TABLE IXcore.`configuration` CHANGE `configuration_value` `configuration_value` TEXT NOT NULL, CHANGE `set_function` `set_function` TEXT NULL DEFAULT NULL");
		...
		tep_db_query("insert into IXcore." . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Sort Order', 'MODULE_SHIPPING_USPS_SORT_ORDER', '0', 'Sort order of display.', '6', '0', now())");
		...
		tep_db_query("insert into IXcore." . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Processing Time', 'MODULE_SHIPPING_USPS_PROCESSING', '1', 'Days to Process Order', '6', '0', now())");
		...
		tep_db_query("insert into IXcore." . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, use_function, date_added) values ('Non USPS Insurance', 'MODULE_SHIPPING_USPS_INS1', '1.75', 'Totals $.01-$50.00', '6', '0', 'currencies->format', now())");
		tep_db_query("insert into IXcore." . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, use_function, date_added) values ('Non USPS Insurance', 'MODULE_SHIPPING_USPS_INS2', '2.25', 'Totals $50.01-$100', '6', '0', 'currencies->format', now())");
		tep_db_query("insert into IXcore." . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, use_function, date_added) values ('Non USPS Insurance', 'MODULE_SHIPPING_USPS_INS3', '2.75', 'Totals $100.01-$200', '6', '0', 'currencies->format', now())");
		tep_db_query("insert into IXcore." . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, use_function, date_added) values ('Non USPS Insurance', 'MODULE_SHIPPING_USPS_INS4', '4.70', 'Totals $200.01-$300', '6', '0', 'currencies->format', now())");
		tep_db_query("insert into IXcore." . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, use_function, date_added) values ('Non USPS Insurance', 'MODULE_SHIPPING_USPS_INS5', '1.00', 'For every $100 over $300 add:', '6', '0', 'currencies->format', now())");
		...
		// # Enable Stamps.com integration Constants

		tep_db_query("INSERT INTO IXcore." . TABLE_CONFIGURATION . " 
					  SET configuration_title = 'Enable Stamps.com Labels', 
					  configuration_key = 'MODULE_SHIPPING_USPS_STAMPS_STATUS', 
					  configuration_value = 'True', 
					  configuration_description = 'Do you want to enable Stamps.com labels from order manager?',
		...
		// # configure Stamps.com API User ID
		tep_db_query("INSERT INTO IXcore." . TABLE_CONFIGURATION . " 
					  SET configuration_title = 'Enter the Stamps.com API User ID', 
					  configuration_key = 'MODULE_SHIPPING_USPS_STAMPS_USERNAME', 
					  configuration_value = '', 
					  configuration_description = 'Enter your Stamps.com API user ID',
					  configuration_group_id = '6', 
					  sort_order = '0', 
					  date_added = NOW()
					  ");
		...
		// # configure Stamps.com API User ID
		tep_db_query("INSERT INTO IXcore." . TABLE_CONFIGURATION . " 
					  SET configuration_title = 'Enter the Stamps.com API Password', 
					  configuration_key = 'MODULE_SHIPPING_USPS_STAMPS_PASSWORD', 
					  configuration_value = '', 
					  configuration_description = 'Enter your Stamps.com API Password',
					  configuration_group_id = '6', 
					  sort_order = '0', 
					  date_added = NOW()
					  ");
		...
		tep_db_query("INSERT INTO IXcore." . TABLE_CONFIGURATION . " 
					  SET configuration_title = 'Stamps.com Access URL for latest WSDL', 
					  configuration_key = 'MODULE_SHIPPING_USPS_STAMPS_ACCESS_URL', 
					  configuration_value = '', 
					  configuration_description = 'Provide the URL specified in SWSIM docs',
					  configuration_group_id = '6', 
					  sort_order = '0', 
					  date_added = NOW()
					  ");
		...
		tep_db_query("INSERT INTO IXcore." . TABLE_CONFIGURATION . " 
					  SET configuration_title = 'Stamps.com Access Integration ID for Auth', 
					  configuration_key = 'MODULE_SHIPPING_USPS_STAMPS_INTEGRATION_ID', 
					  configuration_value = '', 
					  configuration_description = 'Intgeration ID will create Auth string',
					  configuration_group_id = '6', 
					  sort_order = '0', 
					  date_added = NOW()
					  ");
	...
	function keys() {
		return array(
			...
			'MODULE_SHIPPING_USPS_INTERNATIONAL_ONLY',
			...
			'MODULE_SHIPPING_USPS_STAMPS_STATUS',
			'MODULE_SHIPPING_USPS_STAMPS_USERNAME',
			'MODULE_SHIPPING_USPS_STAMPS_PASSWORD',
			'MODULE_SHIPPING_USPS_STAMPS_ACCESS_URL',
			'MODULE_SHIPPING_USPS_STAMPS_INTEGRATION_ID'
		);
	}
	// # End Install Module
	...
	private function sendNotificationEmailTypeChange( $params = array() ){
		tep_mail(
			...
			'The following unsupported shipping types have been detected:'
				...
				. "\n\n"
			,
			'USPS Shipping Module [' . $this->version . ']',
			STORE_OWNER_EMAIL_ADDRESS
		);
	}
}
