...
_roi.push(['_setMerchantId', '<?php echo SHOPPINGCOM_CONVERSION_CODE ?>']); // required
...
_roi.push(['_setOrderId', '<?php echo $order_id?>']); // unique customer order ID
_roi.push(['_setOrderAmount', '<?php echo $analytics_total?>']); // order total without tax and shipping
...
_roi.push(['_addItem',
'<?php echo $items['products_model']?>', // Merchant sku
'<?php echo $items['products_name']?>', // Product name
'<?php echo $category['categories_id']?>', // Category id
'<?php echo $category['categories_name']?>', // Category name
'<?php echo $items['final_price']?>', // Unit price
'<?php echo $items['products_quantity']?>' // Item quantity
]);
