<?php
  ...
  if (isset($_POST['action']) && ($_POST['action'] == 'process')) {
    ...
    $check_email_query = tep_db_query("select count(0) AS total FROM " . TABLE_CUSTOMERS . " WHERE customers_email_address = '" . tep_db_input($email_address) . "' AND customers_id != '" . (int)$customer_id . "'");
      ...
      <tr>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td class="pageHeading" align="right"><?php echo tep_image(DIR_WS_IMAGES . 'table_background_account.gif', HEADING_TITLE); ?></td>
          </tr>
        </table></td>
      </tr>
      <tr>
