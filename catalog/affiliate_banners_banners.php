<?php
  ...
  $breadcrumb->add(NAVBAR_TITLE_AFFILIATE_BANNER_BANNER, tep_href_link(FILENAME_AFFILIATE_BANNERS_BANNERS));
      ...
      <tr>
        <td width="100%"><table border="0" width="100%" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td align="right"><?php echo tep_image(DIR_WS_IMAGES . 'affiliate_summary.png', HEADING_TITLE); ?></td>
          </tr>
	  <tr>
    ...
    while ($affiliate_banners = tep_db_fetch_array($affiliate_banners_values)) {
      ...
      switch (AFFILIATE_KIND_OF_BANNERS) {
        case 1: // Link to Products
          if ($prod_id < 1) {
            $link = '<a href="' . HTTP_SERVER . DIR_WS_CATALOG . FILENAME_DEFAULT . '?ref=' . $affiliate_id . '&affiliate_banner_id=' . $ban_id . '" target="_blank"><img src="' . HTTPS_SERVER . DIR_WS_CATALOG . DIR_WS_IMAGES . $affiliate_banners['affiliate_banners_image'] . '" border="0" alt="' . $affiliate_banners['affiliate_banners_title'] . '"></a>';
        ...
        case 2: // Link to Products
          if ($prod_id < 1) {
            $link = '<a href="' . HTTP_SERVER . DIR_WS_CATALOG . FILENAME_DEFAULT . '?ref=' . $affiliate_id . '&affiliate_banner_id=' . $ban_id . '" target="_blank"><img src="' . HTTPS_SERVER . DIR_WS_CATALOG . FILENAME_AFFILIATE_SHOW_BANNER . '?ref=' . $affiliate_id . '&affiliate_banner_id=' . $ban_id . '" border="0" alt="' . $affiliate_banners['affiliate_banners_title'] . '"></a>';
...
?>
      <tr>
	    ...
	    <textarea style="width:100%; padding:5px;" cols="60" rows="4" class="boxText" onClick="javascript:this.select()"><?php echo $link1; ?></textarea>
   </td>
          </tr>
          </table>
