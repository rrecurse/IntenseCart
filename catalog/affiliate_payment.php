...
?>
            ...
            <td class="smallText" align="right"><?php echo $currencies->format($affiliate_payment['affiliate_payment_total']); ?></td>
...
?>
          <tr>
            <td class="main" colspan="4"><br><?php echo TEXT_INFORMATION_PAYMENT_TOTAL . ' <b>' . $currencies->format($affiliate_payment['total']); ?></b></td>
          </tr>
                <tr>
                  <td colspan="4"><?php echo tep_draw_separator(); ?></td>
                </tr>
