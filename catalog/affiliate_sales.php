...
?>
            ...
            <td class="smallText" align="right"><?php echo $currencies->format($affiliate_sales['affiliate_value']); ?></td>
            <td class="smallText" align="right"><?php echo $affiliate_sales['affiliate_percent'] . " %"; ?></td>
            <td class="smallText" align="right"><?php echo $currencies->format($affiliate_sales['affiliate_payment']); ?></td>
...
?>
            <td class="main" colspan="5"><br><?php echo TEXT_INFORMATION_SALES_TOTAL . ' <b>' .  $currencies->format($sum_of_earnings), '</b>' . TEXT_INFORMATION_SALES_TOTAL2; ?></td>
          </tr>
                <tr>
                  <td colspan="5"><?php echo tep_draw_separator(); ?></td>
                </tr>
