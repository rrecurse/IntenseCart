 ...
 */
  ...
  */
  ...
  class GoogleRequest {
    ...
    /**
     * Method added by Bogdan Stancescu
     *
     * Send an <authorize-order> command to the Google Checkout server
     * 
     * info: {@link http://code.google.com/apis/checkout/developer/Google_Checkout_XML_API_Financial_Commands.html#Authorize_Order}
     * 
     * @param string $google_order the google id of the order
     * 
     * @return array the status code and body of the response
     */
    function SendAuthorizeOrder($google_order) {
      $postargs = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>
                  <authorize-order xmlns=\"".$this->schema_url.
                  "\" google-order-number=\"". $google_order. "\">";
      $postargs .= "</authorize-order>";
