<?php
	...
	//require_once(DIR_FS_COMMON.'modules/payment/paypal/standard_ipn.php');
	require(DIR_FS_CATALOG.DIR_WS_LANGUAGES . $language . '/modules/payment/paypal_standard.php');

	class payment_paypal_ipn extends IXpayment {
    ...
    function __construct() {
      ...
      $this->signature = 'paypal|paypal_ipn|3.2|2.3';
...
// remove shipping tax in total tax value
      ...
      $parameters = array('cmd' => '_cart',
                          ...
                          'custom' => $customer_id,
                          'no_note' => '1',
                          'notify_url' => tep_href_link('modules/payment/paypal/standard_ipn.php', '', 'SSL', false, false),
                          'rm' => '2',
...
// unregister session variables used during checkout
    ...
    function getParams() {
      ...
      $params = array('MODULE_PAYMENT_PAYPAL_STANDARD_ID' => array('title' => 'Seller E-Mail Address',
    ...
    function sendTransactionToGateway($url, $parameters) {
      ...
      if ( MODULE_PAYMENT_PAYPAL_STANDARD_VERIFY_SSL == 'True' ) {
        ...
        if ( file_exists(DIR_FS_CATALOG . 'modules/payment/paypal/paypal.com.crt') ) {
          curl_setopt($curl, CURLOPT_CAINFO, DIR_FS_CATALOG . 'modules/payment/paypal/paypal.com.crt');
