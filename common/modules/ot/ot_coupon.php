<?php
class ot_coupon extends IXmodule {
...
global $PHP_SELF, $currencies;
	...
	if ($od_amount > 0) {
		...
		$totals[] = array('title' => $this->title . ' (' . $this->coupon_code .'):','text' => '<b>-' . $currencies->format($od_amount) . '</b>', 'value' => $od_amount); //Fred added hyphen
	}
    return $totals;
}
...
//error_log(print_r($coupon_result['coupon_type'],1));
